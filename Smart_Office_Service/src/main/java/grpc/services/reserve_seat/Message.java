...
private static final long serialVersionUID = 0L;
  ...
  public enum Enum
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return grpc.services.reserve_seat.Message.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public grpc.services.reserve_seat.Message.Enum getDetail() {
    ...
    grpc.services.reserve_seat.Message.Enum result = grpc.services.reserve_seat.Message.Enum.valueOf(detail_);
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (detail_ != grpc.services.reserve_seat.Message.Enum.UNKNOWN.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof grpc.services.reserve_seat.Message)) {
      return super.equals(obj);
    }
    grpc.services.reserve_seat.Message other = (grpc.services.reserve_seat.Message) obj;
  ...
  public static grpc.services.reserve_seat.Message parseFrom(
  ...
  public static grpc.services.reserve_seat.Message parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static grpc.services.reserve_seat.Message parseFrom(
  ...
  public static grpc.services.reserve_seat.Message parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static grpc.services.reserve_seat.Message parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static grpc.services.reserve_seat.Message parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(grpc.services.reserve_seat.Message prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using grpc.services.reserve_seat.Message.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public grpc.services.reserve_seat.Message getDefaultInstanceForType() {
      return grpc.services.reserve_seat.Message.getDefaultInstance();
    }

    @java.lang.Override
    public grpc.services.reserve_seat.Message build() {
      grpc.services.reserve_seat.Message result = buildPartial();
    ...
    @java.lang.Override
    public grpc.services.reserve_seat.Message buildPartial() {
      grpc.services.reserve_seat.Message result = new grpc.services.reserve_seat.Message(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof grpc.services.reserve_seat.Message) {
        return mergeFrom((grpc.services.reserve_seat.Message)other);
      } else {
    ...
    public Builder mergeFrom(grpc.services.reserve_seat.Message other) {
      if (other == grpc.services.reserve_seat.Message.getDefaultInstance()) return this;
      if (other.detail_ != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      grpc.services.reserve_seat.Message parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (grpc.services.reserve_seat.Message) e.getUnfinishedMessage();
  ...
  public static grpc.services.reserve_seat.Message getDefaultInstance() {
